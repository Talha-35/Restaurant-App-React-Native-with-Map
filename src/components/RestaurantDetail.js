...
const RestaurantDetail = (props) => {
  function showPrice(length) {
    const priceLabel = [];
    // burada for döngüsü ile mekanın yanına ne kadar pahalı ise o kadar dolar işareti koyuyoruz.
  ...
  return (
    <Modal
      ...
      // konumu yerini vs ayarlamak için kullanılır
      onBackdropPress={props.onClose}
      // arka plana tıklandığında modal ekranını kapat demektir.
      swipeDirection="down"  
      // ekranı aşağı çekince modal ekranını kapat demektir.
